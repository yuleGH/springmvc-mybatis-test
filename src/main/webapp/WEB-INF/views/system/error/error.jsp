...
<div class="wrap">
    <table>
        <tr>
            <td rowspan="5" style=""><img src="https://ws1.sinaimg.cn/large/a15b4afegy1fhsfdznep4j2020020web.jpg" alt="服务器端未知错误"></td>
            <td class="header">很抱歉！服务器端出现了未知错误</td>
        </tr>
        <tr><td>请联系管理员！</td></tr>
        <tr><td>或者刷新页面，如没能解决问题，你可以前往<a href="/index.jsp">首页</a></td></tr>
    </table>
</div>
</body>
</html>